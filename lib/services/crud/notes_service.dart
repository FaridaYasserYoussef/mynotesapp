...
//         notesTable, {textColumn: text, isSyncedWithCloudColumn: 0},
...
//     var result = notes.map((noteRow) => DatabaseNote.fromRow(noteRow));
//     return result;
//   }
...
//     if (notes.isEmpty) {
//       throw CouldNotFindNoteExcepton();
//     } else {
...
//   @override
//   String toString() =>
//       'Note: id = $id, user_id = $userId, text = $text, Synced with cloud = $isSyncedWithCloud';
